...
public class HeaderPageContentBuilder {
  ...
  public static HeaderPageContent build(AccountRepository ar, AdminRepository adR, String username){
    return HeaderPageContentBuilder.build(ar,adR,username,HeaderPageContent.HOME_LABEL);
  }
  
  public static HeaderPageContent build(AccountRepository ar, AdminRepository adR, String username, String servletName){
  ...
  public static String convertServletNameToHeaderLabel(String servletName){
    if(servletName.equals("/trainings"))return HeaderPageContent.TRAINING_LABEL;
